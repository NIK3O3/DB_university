...
CREATE TABLE `BenefitTypes` (
  ...
  `BenefitName` varchar(150) NOT NULL,
  `BonusScore` decimal(5,2) NOT NULL DEFAULT '0.00',
  `DescriptionText` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`BenefitTypeID`),
  UNIQUE KEY `BenefitName` (`BenefitName`),
  CONSTRAINT `chk_benefit_bonus` CHECK ((`BonusScore` >= 0))
...
INSERT INTO `BenefitTypes` VALUES (1,'Учасник олімпіади',5.00,'Додаткові конкурсні бали за профільну олімпіаду'),(2,'Дитина учасника бойових дій',3.00,'Пільга відповідно до підтвердного документа'),(3,'Сільський коефіцієнт',2.00,'Додаткові бали за встановленими правилами');
